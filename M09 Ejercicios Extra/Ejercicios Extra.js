...
function numberOfCharacters(string) {
   ...
   var objetoOrdenado = {};
   Object.keys(conteoLetras).sort().forEach(letra => {
      objetoOrdenado[letra] = conteoLetras[letra];
   });
...
function capToFront(string) {
   ...
   // Tu código:
   var mayusculas = string.replace(/[^A-Z]/g, '');
   var minusculas = string.replace(/[^a-z]/g, '');
...
function capicua(numero) {
   ...
   var numeroInvertido = numeroComoCadena.split('').reverse().join('');
   if (numeroComoCadena === numeroInvertido) {
      return "Es capicua";
  } else {
...
function buscoInterseccion(array1, array2) {
   ...
   // Tu código:
   var resultado = array1.filter(numero => array2.includes(numero));
   return resultado;
}
